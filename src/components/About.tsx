  ...
  return (
    ...
    >
      ...
      <p>
        ...
        companies, I've gained valuable experience working with a diverse range
        of technology stacks and tools. Whether I'm immersed in code, leading
        software teams, collaborating with fellow developers, or engaging with
        end users, I'm committed to delivering{" "}
